        ...
        <Affix className="screen">
          <Stack gap={0}>
            ...
            <div className="content">
              <Text>
                Hi! My name is Bill, and welcome to the latest iteration of my
                website. I&apos;ve always wanted to try a 3D project on the web,
                so this refresh seemed like the perfect opportunity.
                &#128736;&#65039;
              </Text>
              <br />
              <Text>
              ...
              <Text>
                ...
                Waterloo, with 7 swe internships under my belt. I have
                experience from producing clean, test-driven code at large
                multi-billion dollar tech corporations; to prototyping,
                iterating, and pivoting products/features at seed-stage startups
                of &lt;10 people. &#129489;&#8205;&#128187;
              </Text>
              <br />
              <Text>
                I&apos;m currently seeking 2024 new grad or internship
                opportunities at companies with cool products and people, so if
                you think I&apos;d be a good fit, I&apos;d love to connect!
                &#128522;
              </Text>
              <br />
              <Text>
                Thanks for visiting! Feel free to shoot me a text in the chat at
                the bottom right &#128071;
              </Text>
              <Text>
